...
<img width="2551" height="1359" alt="image" src="https://github.com/user-attachments/assets/b15e89aa-8223-4dd4-a5bb-514de3e75844" />
...
- В сплит-экране отправка команды сразу во все вкладки с передачей функциональных клавиш.
- В сплит-экране поиск по истории и автозаполненение по TAB 
...
- Функция мониторинга хоста, к которому произведено подключение (панель внизу, включения глобально).
- Проброс Х11
